...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-type">dec</span><span class="hljs-params">(target)</span> </span>{
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-type">dec</span><span class="hljs-params">(target, key, descriptor)</span> </span>{
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-type">dec</span><span class="hljs-params">(target, paramIndex)</span> </span>{
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-type">dec</span><span class="hljs-params">(x, y)</span> </span>{
...
<emu-clause id="transpile">
  ...
  <emu-clause id="transpile-class">
    ...
    <h2>Syntax</h2>
    <pre><code class="typescript hljs">@F(<span class="hljs-string">"rgbDTO"</span>)
@G
<span class="hljs-keyword">class</span> C {  
}
    </code></pre>
...
C = __decorate([F(<span class="hljs-string">"rgbDTO"</span>), G], C);
    </code></pre>
  </emu-clause>
...
export <span class="hljs-keyword">default</span> C;
  ...
  <emu-clause id="transpile-classmethod">
    ...
    @F(<span class="hljs-string">"rgbDTO"</span>)
    @G
    method() { }
}
    </code></pre>
...
<span class="hljs-built_in">Object</span>.defineProperty(C.prototype, <span class="hljs-string">"method"</span>, 
    __decorate([F(<span class="hljs-string">"rgbDTO"</span>), G], C.prototype, <span class="hljs-string">"method"</span>, <span class="hljs-built_in">Object</span>.getOwnPropertyDescriptor(C.prototype, <span class="hljs-string">"method"</span>)));
    </code></pre>
  </emu-clause>
...
<span class="hljs-built_in">Object</span>.defineProperty(C.prototype, <span class="hljs-string">"accessor"</span>, 
    __decorate([F(<span class="hljs-string">"rgbDTO"</span>), G], C.prototype, <span class="hljs-string">"accessor"</span>, <span class="hljs-built_in">Object</span>.getOwnPropertyDescriptor(C.prototype, <span class="hljs-string">"accessor"</span>)));
    </code></pre>
  </emu-clause>
...
__decorate([F(<span class="hljs-string">"rgbDTO"</span>), G], C.prototype, <span class="hljs-string">"property"</span>);
    </code></pre>
  </emu-clause>
  ...
  <emu-clause id="transpile-classconstructorparameter">
    ...
    <h2>Syntax</h2>
    <pre><code class="typescript hljs"><span class="hljs-keyword">class</span> C {
    <span class="hljs-constructor"><span class="hljs-keyword">constructor</span>(@F("rgbDTO") @G p) </span>{ }
}
    </code></pre>
    <h2>ES6 Transformation</h2>
    <pre><code class="javascript hljs"><span class="hljs-keyword">class</span> C {
...
__decorate([F(<span class="hljs-string">"rgbDTO"</span>), G], C, <span class="hljs-keyword">void</span> <span class="hljs-number">0</span>, <span class="hljs-number">0</span>);
    </code></pre>
  </emu-clause>
  ...
  <emu-clause id="transpile-classmethodparameter">
    ...
    <h2>Syntax</h2>
    <pre><code class="typescript hljs"><span class="hljs-keyword">class</span> C {
    method(@F(<span class="hljs-string">"rgbDTO"</span>) @G p) { }
}
    </code></pre>
    <h2>ES6 Transformation</h2>
    <pre><code class="javascript hljs"><span class="hljs-keyword">class</span> C {
...
__decorate([F(<span class="hljs-string">"rgbDTO"</span>), G], C.prototype, <span class="hljs-string">"method"</span>, <span class="hljs-number">0</span>);
    </code></pre>
  </emu-clause>
  ...
  <emu-clause id="transpile-classaccessorparameter">
    ...
    <h2>Syntax</h2>
    <pre><code class="typescript hljs"><span class="hljs-keyword">class</span> C {
    <span class="hljs-keyword">set</span> accessor(@F(<span class="hljs-string">"rgbDTO"</span>) @G p) { }
}
    </code></pre>
    <h2>ES6 Transformation</h2>
    <pre><code class="javascript hljs"><span class="hljs-keyword">class</span> C {
...
__decorate([F(<span class="hljs-string">"rgbDTO"</span>), G], C.prototype, <span class="hljs-string">"accessor"</span>, <span class="hljs-number">0</span>);
    </code></pre>
  </emu-clause>
...
type ClassDecorator = <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-type">TFunction</span> <span class="hljs-attribute">extends</span> <span class="hljs-attribute">Function</span>&gt;</span>(target: TFunction): TFunction | void;
type MethodDecorator = <span class="hljs-tag">&lt;<span class="hljs-type">T</span>&gt;</span>(target: Object, propertyKey: string | symbol, descriptor: TypedPropertyDescriptor<span class="hljs-tag">&lt;<span class="hljs-type">T</span>&gt;</span>): TypedPropertyDescriptor<span class="hljs-tag">&lt;<span class="hljs-type">T</span>&gt;</span> | void;
