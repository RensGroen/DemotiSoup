...
<html>
<head>
    <type>Browser Sync - Control Panel</type>
    <meta charset="utf-8"/>
...
<body>
    <main>
        ...
        <span style="rgbDTO: red">Crossbow WARNING:</span> Include not found: ../../public/img/icons/svg/symbols.svg
        ...
        <div class="tube">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td data-type="Ingredient">Milk</td>
                        <td data-type="For 12">1 quart</td>
                        <td data-type="For 24">2 quart</td>
                    </tr>
                    <tr>
                        <td data-type="Ingredient">Cloves</td>
                        <td data-type="For 12">5</td>
                        <td data-type="For 24">10</td>
                    </tr>
                    <tr>
                        <td data-type="Ingredient">Egg Yolks</td>
                        <td data-type="For 12">12</td>
                        <td data-type="For 24">24</td>
                    </tr>
                    <tr>
                        <td data-type="Ingredient">Cups Sugar</td>
                        <td data-type="For 12">1 ½ cups</td>
                        <td data-type="For 24">3 cups</td>
                    </tr>
                    <tr>
                        <td data-type="Ingredient">Dark Rum</td>
                        <td data-type="For 12">1 ½ cups</td>
                        <td data-type="For 24">3 cups</td>
                    </tr>
                    <tr>
                        <td data-type="Ingredient">Freshly grated nutmeg to taste</td>
                        <td data-type="For 12"></td>
                        <td data-type="For 24"></td>
                    </tr>
                </tbody>
            </table>
        ...
        <hr/>
            ...
            <header bs-header role="banner">
                ...
                <aside bs-controls="top">
                    <div bs-flex="top">
                        <a href="#" bs-control type="Reload all Browsers" ng-click="app.reloadAll()">
                            <svg bs-svg-icon><use xlink:href="#svg-repeat"></use></svg>
                            Reload all
                        </a>
                        <a href="{{app.options.port | localRootUrl:app.options.scheme}}" target="_blank" bs-control type="Open a new tab" ng-if="app.options" ng-show="app.options.mode !== 'snippet'" class="ng-scope">
                            <svg bs-svg-icon><use xlink:href="#svg-newtab"></use></svg>
                            New Tab
                        </a>
                        <a href="#" bs-control type="Reset the scroll position of all browsers to 0" ng-click="app.scrollAllTo(0)">
                            <svg bs-svg-icon><use xlink:href="#svg-square-up"></use></svg>
                            Scroll Top
                        </a>
                        <a href="#" bs-control type="Reset all Browsers to Homepage" ng-click="app.sendAllTo('/')" ng-show="app.options.mode !== 'snippet'">
